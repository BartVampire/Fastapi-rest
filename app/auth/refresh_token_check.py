...
from app.api.auth_v1.auth_token_helpers import create_access_token
from app.api.auth_v1.token_crud import is_token_blacklisted, add_tokens_to_db
from app.api.auth_v1.validation_auth_helper_refresh import (
    get_current_auth_user_for_refresh,
)
from app.auth.utils_jwt import decode_jwt
...
async def check_and_refresh_token_dependency(
    ...
    async for db in db_helper.session_getter():
        ...
        if (
            ...
            # )
            print(f"check_and_refresh_token_dependency: {type(new_access_token)}")
